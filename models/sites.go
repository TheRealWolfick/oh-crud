...
type Domain struct {
	Domain_code *string `json:"domain_code"                   db:"domain_code"         req:"true"  pk:"true"  none:""  explicit:""     `
	Description *string `json:"domain_description,omitempty"  db:"domain_description"  req:""      pk:""      none:""  explicit:""     `
}

type GetDomain struct {
	Domain_code *string `json:"domain_code,omitempty"         db:"domain_code"         req:"true"  pk:"true"  none:""  explicit:""     `
	Description *string `json:"domain_description,omitempty"  db:"domain_description"  req:""      pk:""      none:""  explicit:""     `
}

type Building struct {
	Building_id	 					*int     `json:"building_id,omitempty"           db:"building_id"           req:""      pk:"true"  none:"DEFAULT"  explicit:""     `
	Building 							*string  `json:"building,omitempty"              db:"building"              req:"true"  pk:"true"  none:""         explicit:""     `
	Db_domain 						*string  `json:"db_domain,omitempty"             db:"db_domain"             req:"true"  pk:""      none:""         explicit:""     `
...
type Floors struct {
	...
	Floor      *string  `json:"floor"               db:"floor"     pk:"true"  req:"true"  none:""         explicit:"true" `
}

type Building_Floor struct {
	Bfloor_id   *int     `json:"bfloor_id,omitempty"  db:"bfloor_id"  req:""      pk:"true"  none:"DEFAULT"  explicit:""     `
	Building 		*string  `json:"building"             db:"building"   req:"true"  pk:"true"  none:""         explicit:""     `
	Floor       *string  `json:"floor"                db:"floor"      req:"true"  pk:""      none:""         explicit:"true" `
	Is_active   *bool    `json:"is_active,omitempty"  db:"is_active"  req:""      pk:""      none:"DEFAULT"  explicit:""     `
}
...
type Building_Floor_Room struct {
	...
	Building					*string  `json:"building"                    db:"building"         req:"true"  pk:"true"  none:""         explicit:""     `
	Floor							*string  `json:"floor"                       db:"floor"            req:"true"  pk:"true"  none:""         explicit:"true" `
	Room							*string  `json:"room"                        db:"room"             req:"true"  pk:"true"  none:""         explicit:""     `
...
type Departments struct {
	...
	Dept_code  *string  `json:"dept_code"            db:"dept_code"  req:"true"  pk:"true"  none:""         explicit:""     `
